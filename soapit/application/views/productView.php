		...
		<div class="container px-lg-5">
		  <div class="row mx-lg-n5">
			<div class="col py-0 px-lg-0 border bg-light">
				...
				<img src="'.base_url().'images/'.$row->productimage.'"  class="img-fluid" >
			...
			<div class="col py-3 px-lg-5 border bg-light">
				...
				<label style="font-size: 3vh;font-weight: 600;">Quantity</label>
		<input type="text" name="quantity" class="quantity" id="'.$row->productid.'" />
		<button type="button" name="add_cart" class="btn btn-success add_cart" data-productname="'.$row->productname.'" data-price="'.$row->price.'" data-productid="'.$row->productid.'" />Add To Cart</button>
